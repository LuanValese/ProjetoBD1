            ...
            <div class=container-fluid>
                    ...
                    <div class="collapse navbar-collapse" id="navbarMenu">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a href="http://localhost/SipEm/indexM.php" style="font-weight:650;" class="nav-link">Matrículas</a>
                            </li>
                        </ul>
                    </div> 
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col">    
                        <div class="form-group">
                            ...
                            <input name="modalidade" id="modalidade" class="form-control" type="text" required>
                        </div>
                    </div> 
                    <div class="col">   
                        <div class="form-group">
            ...
            <table class= "table table-striped">
                ...
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td><?php echo $linha['modalidade'] ?></td>
