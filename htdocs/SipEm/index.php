            ...
            <table class= "table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <button type="button" style="margin-right: 10px"class="btn btn-dark">
                                <a style="text-decoration: none; color: inherit;" href="matricula.php?id=<?php echo $linha['id']?>">Matrículas</a> 
                        </button>
